...
{
    [MKStoreManager setObject:[NSNumber numberWithInt:1] forKey:(NSString*)strRemoveAd];
}

+ (BOOL)isPaidVersion
{
    return [MKStoreManager isFeaturePurchased:strRemoveAd];
